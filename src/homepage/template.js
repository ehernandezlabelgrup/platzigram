...
module.exports = function (pictures){
       var el = yo`
<div class="contaienr timeline">
<div class="row">
  <div class="col s12 m10 offset-m1 l8 offset-l2 center-align">
    <form enctype="multipart/from-data" class="form-upload" onsubmit=${onsubmit} id="formUpload">
      <div id="fileName" class="fileUpload btn btn-flat cyan">
        <span><i class="fa fa-camera" aria-hidden="true"></i> ${translate.message('upload-file')}</span>
